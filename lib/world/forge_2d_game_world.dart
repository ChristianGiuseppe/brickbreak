...
class Forge2dGameWorld extends Forge2DGame with HasDraggables, HasTappables {
  ...
  void onTapDown(int pointerId, TapDownInfo info) {
    if (gameState == GameState.ready) {
      ...
      _ball.body.applyLinearImpulse(Vector2(-10,
          -10)); //rappresenta la forza applicata alla palla _ball.body.applyLinearImpulse(Vector2(-10.0, -10.0));
  ...
  Future<void> _initGame() async {
    ...
    _ball = BallComponent(position: ballPosition, radius: 0.5);
    await add(_ball);
